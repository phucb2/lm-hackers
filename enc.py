...
class SimpleBytePairEncoding:
    ...
    def encode(self, text: str, visualise: Optional[str] = None) -> list[int]:
    ...
    @staticmethod
    def train(training_data: str, vocab_size: int, pat_str: str, visualise: Optional[str] = "colour"):
...
if __name__ == "__main__":
    ...
    # enc = SimpleBytePairEncoding.train(text, vocab_size=600, pat_str=gpt2_pattern, visualise=None)
    ...
    print(enc.encode("hello world"))
    print(enc.decode(enc.encode("hello world")))
    print(len(enc.mergeable_ranks))
    with open('input.txt') as f:
        text = f.read()
    sample = text[:300]
    print(enc.encode(sample, visualise=None))
    print(enc.decode(enc.encode(sample, visualise=None)))
